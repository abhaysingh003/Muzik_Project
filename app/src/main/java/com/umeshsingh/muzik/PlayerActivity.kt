...
import com.umeshsingh.muzik.databinding.ActivityPlayerBinding
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.repeatBtnPA.setOnClickListener {
            if(!repeat){
                repeat = true
                binding.repeatBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.cool_skyBlue))
            }else{
                repeat = false
...
//Important Function
    ...
    private fun setLayout(){
        ...
        binding.songNamePA.text = musicListPA[songPosition].title
        if(repeat) binding.repeatBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.cool_skyBlue))
        if(min15 || min30 || min60) binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.cool_skyBlue))
    ...
    private fun showBottomSheetDialog(){
        ...
        dialog.findViewById<LinearLayout>(R.id.min_15)?.setOnClickListener {
            ...
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.cool_skyBlue))
            min15 = true
